...
Una vez considerada la interpretablidad de ambas métricas, se contrastará su capacidad para discriminar predictores con curvas que se cruzan y de igual $pAUC$. Del conjunto de datos, 917 predictores presentan un $pAUC$ igual al menos a otro, formandose 407 grupos en función de esta métrica. Para estudiar la capacidad de discriminación, se utilizarán los predictores `ENSG00000177943` y `ENSG00000136783`, aquellos de mayor $pAUC$ entre los grupos formados.
