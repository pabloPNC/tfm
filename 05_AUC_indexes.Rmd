...
El desarrollo de nuevas tecnologías permite el análisis de un gran número de marcadores simultáneamente, donde un análisis basado en $AUC$ son utilizados habitualmente. En el ámbito clínico, regiones concretas de la curva pueden son más relevantes para tratar con los costes de diagnósticos erróneos, como consecuencia las métricas que evaluan estas regiones, como el $pAUC$, están ganando mayor interés. A pesar de ello esta métrica presenta limitaciones para su uso debido a su interpretabilidad, por lo que transformaciones alternativas para regiones concretas, son de mayor utilidad.

El $SpAUC$ fue la primera transformación del $pAUC$ para trabajar en regiones de alta especificidad. Aunque la métrica presenta una mayor interpretabilidad al comprender sus valores entre $0.5$ y $1$, no es aplicable a regiones que pasen por debajo de la línea de azar, limitando su uso. De forma similar para las regiones de alta sensibilidad se propuso el $NpAUC$, la cual aunque limitada por encima a tomar valores inferiores a $1$ no se encuentra limitada por debajo pudiendo tomar valores inferiores a $0.5$ en ciertas curvas.
